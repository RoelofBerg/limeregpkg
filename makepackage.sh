...
pushd ../liblimereg
git archive v0.9.2 --format=tar.gz --prefix=liblimereg-dev-0.9.2/ . > ../limeregpkg/liblimereg-dev-0.9.2.tar.gz
popd
...
git init
git-import-orig -u 0.9.2 ../liblimereg-dev-0.9.2.tar.gz
...
echo sudo pbuilder --build liblimereg-dev_0.9.2-0.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg liblimereg-dev_0.9.2-0ubuntu1_source.changes

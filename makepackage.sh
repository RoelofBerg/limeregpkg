...
pushd ../limereg
git archive v1.2.1 --format=tar.gz --prefix=limereg-1.2.1/ . > ../limeregpkg/limereg-1.2.1.tar.gz
popd
...
pushd limereg
git init
git-import-orig -u 1.2.1 ../limereg-1.2.1.tar.gz
...
echo sudo pbuilder --build limereg_1.2.1-0.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg limereg_1.2.1-0ubuntu1_source.changes

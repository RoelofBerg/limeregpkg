...
pushd limereg
git init
git-import-orig -u 1.4.0 ../../limereg/limereg-1.4.0.tar.gz
...
cd limereg
echo now build the binary package: git-buildpackage --git-ignore-new -S
...
echo sudo pbuilder --build limereg_1.4.0-0.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg limereg_1.4.0-0ubuntu1_source.changes

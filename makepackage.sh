...
pushd ../liblimereg
git archive v0.9.2 --format=tar.gz --prefix=liblimereg0-0.9.2/ . > ../limeregpkg/liblimereg0-0.9.2.tar.gz
popd
...
pushd liblimereg0
git init
git-import-orig -u 0.9.2 ../liblimereg0-0.9.2.tar.gz
...
echo sudo pbuilder --build liblimereg0_0.9.2-0.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg liblimereg0_0.9.2-0ubuntu1_source.changes

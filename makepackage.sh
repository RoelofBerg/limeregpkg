...
pushd ../liblimereg
git archive v0.9.1 --format=tar.gz --prefix=liblimereg0-0.9.1/ . > ../limeregpkg/liblimereg0-0.9.1.tar.gz
popd
...
pushd liblimereg0
git init
git-import-orig -u 0.9.1 ../liblimereg0-0.9.1.tar.gz
...
echo sudo pbuilder --build liblimereg0_0.9.1-0.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg liblimereg0_0.9.1-0ubuntu1_source.changes

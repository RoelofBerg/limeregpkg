...
pushd ../liblimereg
git archive v0.9.0 --format=tar.gz --prefix=liblimereg-0.9.0/ . > ../limeregpkg/liblimereg-0.9.0.tar.gz
popd
...
pushd liblimereg
git init
git-import-orig -u 0.9.0 ../liblimereg-0.9.0.tar.gz
...
echo sudo pbuilder --build liblimereg_0.9.0-1.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg liblimereg_0.9.0-0ubuntu1_source.changes

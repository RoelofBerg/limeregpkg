...
pushd ../limereg
git archive v1.2.0 --format=tar.gz --prefix=limereg-1.2.0/ . > ../limeregpkg/limereg-1.2.0.tar.gz
popd
...
pushd limereg
git init
git-import-orig -u 1.2.0 ../limereg-1.2.0.tar.gz
...
echo sudo pbuilder --build limereg_1.2.0-1.dsc
...
echo of conduct
echo dput ppa:roelofberg/limereg limereg_1.2.0-0ubuntu1_source.changes
